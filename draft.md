...
title: 離れていても響く声
synopsis:>
  :::todo[attention, interest, demand を作り出す文章]
  カフェバーを経営する石谷は、新しい店舗物件が見つからならい。
  怪我をして、将来が心配な娘にバイトをしてもらう。
  ビデオ通話をきっかけに、オンライン・オフラインを交えたパーティを企画。最新のITにつよい娘がやってくれるが、開店直前にトラブルが発生する。
  :::
---
...
電車の中吊り広告の問題は、難問よりも、一問目が簡単だと、二問目も真剣に見る。

キャバクラでは人気があるのは、容姿ではなくて、この子なら俺のことを好きになるんじゃないか、と思わせられるスタッフ。

開店時間が近づき、挨拶をして店に戻ることにした。

普段は遠くに住んでいる娘のことは気にならないのに、長い休みでこっちに来て目の前にいると、アドバイスや小言を言いたくなる。ぼんやりと娘のことを考えていた。
...
私だってそうだった。
半導体メーカーの技術者だったころの顧客対応は、目の前の技術的問題解決が仕事であって、接客ではなかった。
それがリストラされて、次の仕事もみつからない
キャバクラのボーイで食いつないでいたときは、客にも店長にも愛想が悪いと叱られたものだ。愛想というのは気持ちではなく、技能だ。
...
- 店に戻てケーブルとかやってると、弥生も戻る
- ヘッドホンで調整するとうまくいく
- 石谷がインストールする / 娘がケーブルとかをつなぐ
- DSP がなにか？ / 信号処理
- 娘がこれはハウリングを抑える機械？ / スピーカーから出した音がマイクに入ったらそれを消すプログラムをするのだ
- サンプルコードを改造して、音を出したり取り込んだりしてプログラムを書く
- 何をやってるのか分からない / ながながと説明する
- オタクっぽいよ / 親子だな
- 実験する / ちょっとエコー
- 調整する / エコーが消える
...
石谷は自分だけではできなかった。お客さんどうしが、話を回してくれたり、石谷さんにオーダーとらなくていいのかとか言ってくれた。

:::

:::todo[喋らない弥生が、大野さんに助けられるエピソードを追加]

開店直後はテンションでやっていた弥生が、オタクトークが受け入れられない。
戸惑い始めたところを、大野さんが助けてくれる。
...
弥生はジンジャーエール、私はビールを取り出し、中庭のベンチに腰掛ける。あたたかい風が顔にあたる。

:::todo[桜を軽く描写。最後の開花だと話す。]
桜の花はとっくに散ってしまった。
葉が出てきている。新緑の香りがする。葉がこすれる音がする。
:::
...
弥生と私は立ち上がり、缶をゴミ袋にいれる。
今日の準備を振り替り、周波数を制限したらいいんじゃないかとか話しながら、歩く
