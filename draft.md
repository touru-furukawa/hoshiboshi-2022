---
title: 離れていても響く声
synopsis: ::todo[attention, interest, demand を作り出す文章]
---
...
::todo[ログだけすりガラスにしている、隙間から見えると描写する]
...
::todo[DSP に関して、読者に why と how を語り、状況を理解させる。弥生に what を語り、二人のキャラを読者に伝える]
...
::todo[喋らない弥生が、大野さんに助けられるエピソードを追加]
::todo[客同士でもりあげてもらうエピソードを追加]
...
::todo[桜を軽く描写。最後の開花だと話す。]
::todo[タイムカプセルがどうなったかは書かない]
...
::todo[立ち上がって、準備を振り替えりながら話しながら、歩く]
